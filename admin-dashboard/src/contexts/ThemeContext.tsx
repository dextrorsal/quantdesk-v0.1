...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedColor) {
      // apply primary and darker shade
      ...
      const defaultColors = { lite: '#3b82f6', pro: '#f97316' }
      const defaultSecondaryColors = { lite: '#2563eb', pro: '#ea580c' }
      const defaultSuccessColors = { lite: '#22c55e', pro: '#22c55e' }
      const defaultSuccessSecondaryColors = { lite: '#16a34a', pro: '#16a34a' }
  ...
  const toggleTheme = () => setThemeState(prev => prev === 'lite' ? 'pro' : 'lite')
