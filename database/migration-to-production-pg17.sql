-- QuantDesk Database Migration Script for PostgreSQL 17
-- PostgreSQL 17 compatible version WITHOUT TimescaleDB
-- Use this script for your PostgreSQL 17 Supabase project
...
-- =============================================
-- STEP 1: ADD MISSING EXTENSIONS (PostgreSQL 17 Compatible)
-- =============================================

CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "pgcrypto";
-- Note: TimescaleDB is not available in PostgreSQL 17
...
-- =============================================
-- STEP 5: ADD MISSING INDEXES (PostgreSQL 17 Optimized)
-- =============================================
...
-- Oracle prices indexes (critical for performance) - PostgreSQL 17 optimized
CREATE INDEX IF NOT EXISTS idx_oracle_prices_market_time ON oracle_prices(market_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_oracle_prices_created_at_partial ON oracle_prices(created_at) 
...
VALUES ('migration', '{"version": "2.0-pg17", "description": "PostgreSQL 17 compatible migration completed", "timescaledb": false}', 'info');

-- Display completion message
DO $$
BEGIN
    RAISE NOTICE '=============================================';
    RAISE NOTICE 'POSTGRESQL 17 MIGRATION COMPLETED SUCCESSFULLY!';
    RAISE NOTICE '=============================================';
    RAISE NOTICE 'Your database is now ready for production perpetual trading.';
    RAISE NOTICE 'PostgreSQL 17 compatible version (without TimescaleDB)';
    RAISE NOTICE '';
    RAISE NOTICE 'Key differences from PostgreSQL 15 version:';
    RAISE NOTICE '- TimescaleDB features disabled (not available in PG 17)';
    RAISE NOTICE '- Optimized indexes for better performance';
    RAISE NOTICE '- All other features fully functional';
    RAISE NOTICE '';
