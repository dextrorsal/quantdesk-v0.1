...
/**
 * Test Pyth Hermes Client - REST API with correct parameter format
 * Using @pythnetwork/hermes-client package
 */

const { HermesClient } = require('@pythnetwork/hermes-client');

console.log('🚀 Testing Pyth Hermes Client - REST API with correct format...\n');

async function testHermesRestCorrect() {
  try {
    ...
    const priceUpdates = await hermesClient.getLatestPriceUpdates(ids);
