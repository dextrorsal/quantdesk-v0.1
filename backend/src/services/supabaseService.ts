...
const supabaseConfig: SupabaseConfig = {
  url: process.env.SUPABASE_URL || 'https://vabqtnsrmvccgegzvztv.supabase.co',
  anonKey: process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZhYnF0bnNybXZjY2dlZ3p2enR2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg2ODIxMTMsImV4cCI6MjA3NDI1ODExM30.Eof_X57BnJh5JnxUNjRBSkFa22GbQajN01aFACbwZW4'
};
