...
router.get('/metrics', async (req: Request, res: Response) => {
  try {
    ...
    const riskMetrics = await advancedRiskManagementService.calculateRiskMetrics(
      positions,
      portfolioValue,
      historicalReturns
    );
...
router.get('/alerts', async (req: Request, res: Response) => {
  try {
    ...
    const alerts = await advancedRiskManagementService.getUserRiskAlerts(userId);
...
router.post('/check', async (req: Request, res: Response) => {
  try {
    ...
    const alerts = await advancedRiskManagementService.checkRiskLimits(
      userId,
      riskMetrics,
      positions,
      portfolioValue
