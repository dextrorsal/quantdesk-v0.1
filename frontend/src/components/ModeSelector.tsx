    ...
    return (
      <div style={{
        ...
        <button
          ...
          style={{
            padding: '2px 8px',
            backgroundColor: currentMode === 'lite' ? '#3b82f6' : 'transparent',
        ...
        <button
          ...
          style={{
            padding: '2px 8px',
            backgroundColor: currentMode === 'pro' ? '#f97316' : 'transparent',
  ...
  return (
    <div style={{
      ...
      <button
        ...
        style={{
          padding: '8px 16px',
          backgroundColor: currentMode === 'lite' ? '#3b82f6' : '#333',
      ...
      <button
        ...
        style={{
          padding: '8px 16px',
          backgroundColor: currentMode === 'pro' ? '#f97316' : '#333',
