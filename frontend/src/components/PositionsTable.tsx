    ...
    return (
      <div className="trading-card">
        <div className="text-center py-12">
          <div className="w-16 h-16 panel-blue rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <table className="w-full">
          ...
          <tbody>
            {sortedPositions.map((position) => (
              <tr key={position.id} className="border-b border-gray-800 hover:bg-primary-500/10">
