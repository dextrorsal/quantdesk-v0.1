      ...
      <div className="relative z-20">
        ...
        <section className="relative overflow-hidden py-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            {/* Beta Test Signup Section */}
            <div className="mt-4 text-center">
              <p className="text-2xl text-green-400 mb-3 font-semibold">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group inline-flex items-center space-x-2 bg-black hover:bg-purple-400 border border-purple-400 hover:border-purple-400 text-purple-400 hover:text-black px-8 py-4 rounded-lg font-mono font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-purple-400/50"
              >
                <span>Sign Up</span>
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </a>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="pt-8 border-t border-gray-800">
            ...
            <div className="text-center text-gray-500 text-xs">
              <p>&copy; 2025 QuantDesk Protocol. Built for professional traders.</p>
