...
- [QuantDesk Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [TradingPosition Model](./data-models.md#tradingposition-model)
    - [TradingOrder Model](./data-models.md#tradingorder-model)
    - [MarketData Model](./data-models.md#marketdata-model)
    - [Portfolio Model](./data-models.md#portfolio-model)
    - [AIAnalysis Model](./data-models.md#aianalysis-model)
  - [Components](./components.md)
    - [Backend API Gateway](./components.md#backend-api-gateway)
    - [Frontend Trading Interface](./components.md#frontend-trading-interface)
    - [MIKEY AI Assistant](./components.md#mikey-ai-assistant)
    - [Data Ingestion Pipeline](./components.md#data-ingestion-pipeline)
    - [Smart Contract Layer](./components.md#smart-contract-layer)
    - [Database Service Layer](./components.md#database-service-layer)
    - [Component Diagrams](./components.md#component-diagrams)
  - [External APIs](./external-apis.md)
    - [Pyth Network API](./external-apis.md#pyth-network-api)
    - [Supabase API](./external-apis.md#supabase-api)
    - [External LLM APIs (OpenAI/Anthropic)](./external-apis.md#external-llm-apis-openaianthropic)
    - [Solana RPC API](./external-apis.md#solana-rpc-api)
    - [Vercel API](./external-apis.md#vercel-api)
  - [Core Workflows](./core-workflows.md)
    - [User Authentication and Trading Session Workflow](./core-workflows.md#user-authentication-and-trading-session-workflow)
    - [Real-Time Market Data Flow](./core-workflows.md#real-time-market-data-flow)
    - [AI-Assisted Trading Order Workflow](./core-workflows.md#ai-assisted-trading-order-workflow)
    - [Error Handling and Recovery Workflow](./core-workflows.md#error-handling-and-recovery-workflow)
    - [Position Management and Risk Monitoring](./core-workflows.md#position-management-and-risk-monitoring)
  ...
  - [Next Steps](./next-steps.md)
    ...
    - [Architecture Prompt for Frontend](./next-steps.md#architecture-prompt-for-frontend)
